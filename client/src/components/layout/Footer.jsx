...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: <Instagram size={20} />, href: 'https://instagram.com/ajiradigital' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-white/80 mb-6">
              Empowering youth through digital skills and online work opportunities at Kiambu National Polytechnic.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/marketplace" className="text-sm text-white/80 hover:text-white">Marketplace</Link>
              </li>
              <li>
                <Link to="/videos" className="text-sm text-white/80 hover:text-white">Video Tutorials</Link>
              </li>
              <li>
                <Link to="/stories" className="text-sm text-white/80 hover:text-white">Success Stories</Link>
              </li>
              <li>
                <a 
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <p className="text-sm text-white/80">
                  Kiambu National Polytechnic<br />
                  P.O. Box 414-00900<br />
                  Kiambu, Kenya
                </p>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-ajira-accent" />
                <a href="mailto:kinapajira@gmail.com" className="text-sm text-white/80 hover:text-white">
                  kinapajira@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-ajira-accent" />
                <a href="tel:+254792343958" className="text-sm text-white/80 hover:text-white">
                  +254 792 343 958
                </a>
              </li>
            </ul>
