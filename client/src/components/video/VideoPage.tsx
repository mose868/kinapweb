    ...
    <div className='flex min-h-screen bg-gray-100'>
      ...
      <aside className='w-60 bg-ajira-primary text-white p-4 hidden md:block'>
        ...
        <nav className='space-y-4'>
          <a href='#' className='block hover:text-ajira-accent'>
            Home
          </a>
          <a href='#' className='block hover:text-ajira-accent'>
            Trending
      ...
      <main className='flex-1 flex flex-col'>
        ...
        <div className='flex flex-1 overflow-auto'>
          ...
          <section className='flex-1 p-6'>
            <div
              className='relative aspect-w-16 aspect-h-9 bg-black mb-4 rounded-lg overflow-hidden group cursor-pointer'
            ...
            <div className='flex items-center justify-between text-gray-600 text-sm mb-4'>
              <div className='flex items-center space-x-2'>
                <span>
                  {mainVideo.views} • {mainVideo.date}
                </span>
            ...
            <div className='flex items-center mb-4'>
              ...
              <button className='bg-ajira-accent text-white px-4 py-2 rounded hover:bg-ajira-accent/90 transition'>
                Subscribe
              </button>
            ...
            <div className='bg-gray-50 p-4 rounded mb-6'>
              <p>
                {mainVideo.title} - Watch this video to learn more about{' '}
                {mainVideo.channel} and how to get started!
              </p>
            </div>
            <div>
