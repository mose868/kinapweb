...
const ProfileCompletionBanner: React.FC<ProfileCompletionBannerProps> = ({
  ...
  // Ensure we have safe defaults in case checkProfileRequirements fails
  const result = checkProfileRequirements(profileData, feature);
  const { 
    allowed = false, 
    completion = 0, 
    ...
    switch (feature) {
      case 'community':
        return {
          ...
          description:
            'Help us understand your interests to match you with the right community groups. Your profile helps create better learning communities.',
      ...
      case 'ambassador':
        return {
          ...
          description:
            'Represent KiNaP Ajira Club and help other students succeed in their digital journey.',
      ...
      case 'marketplace':
        return {
          ...
          description:
            'Start offering services or browse available opportunities.',
    ...
    <div className={`border rounded-lg p-6 mb-6 ${featureInfo.color}`}>
      <div className='flex items-start gap-4'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-sm mb-4 opacity-90'>{featureInfo.description}</p>
