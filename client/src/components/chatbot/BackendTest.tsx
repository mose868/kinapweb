    ...
    <div className='max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg'>
      ...
      <div className='text-sm text-gray-600'>
        ...
        <ol className='list-decimal list-inside space-y-1'>
          <li>
            First, test the backend connection to verify the server is running
          </li>
          <li>
            If connected, you can send messages to test the chatbot responses
          </li>
          <li>Check the browser console for detailed error messages</li>
          <li>Make sure your backend server is running on port 5000</li>
          <li>
            Ensure the{' '}
            <code className='bg-gray-100 px-1 rounded'>GEMINI_API_KEY</code> is
            set in your backend{' '}
