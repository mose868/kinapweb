...
import { Send, MessageCircle, X, Minimize2, Maximize2, Bot, User, Paperclip, Smile, Mic, Trash2, Image, File, Video, Music } from 'lucide-react';
...
const Chatbot: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (savedMessages) {
      ...
      localStorage.setItem('kinap-chatbot-messages', JSON.stringify([welcomeMessage]));
    }
  }, []);
  ...
  return (
    <div className="fixed left-6 bottom-6 z-50 w-96 h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
      ...
      {!isMinimized && (
        <>
          ...
          <div 
            ...
            className="flex-1 h-80 overflow-y-auto bg-gray-50 p-4 space-y-3 scroll-smooth"
            style={{ 
