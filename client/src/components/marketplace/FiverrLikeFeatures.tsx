...
export const GigStats = ({ stats }: { stats: any }) => (
  <div className='grid grid-cols-3 gap-4 py-4 border-t border-ajira-gray-200'>
    ...
    <div className='text-center'>
      <div className='text-2xl font-bold text-ajira-secondary'>
        {stats.rating || 0}
      </div>
      ...
      <div className='max-w-7xl mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-ajira-text-muted max-w-3xl mx-auto'>
            From creative design to technical development, find the perfect
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='flex items-center justify-center gap-3'>
              ...
              <div>
                ...
                <div className='text-sm text-ajira-text-muted'>
                  Secure Payments
                </div>
              </div>
            </div>
    ...
    <section className='py-20 bg-gradient-to-br from-ajira-primary/5 to-ajira-secondary/5'>
      <div className='max-w-7xl mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-ajira-text-muted max-w-3xl mx-auto'>
            Real success stories from businesses that have grown with KiNaP
            Digital Marketplace
          </p>
        </div>
            ...
            >
              ...
              <div className='flex items-center gap-1 mb-6'>
                {[...Array(testimonial.rating)].map((_, i) => (
                  <Star
                    key={i}
                    className='w-5 h-5 text-ajira-warning fill-current'
                  />
                ))}
              </div>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <div className='flex items-center gap-2'>
                    <h4 className='font-bold text-ajira-text-primary'>
                      {testimonial.name}
                    </h4>
                  ...
                  <p className='text-sm text-ajira-text-muted'>
                    {testimonial.role}
                  </p>
                </div>
              </div>
  ...
  const steps = [
    {
      ...
      description:
        'Explore thousands of services from verified Kenyan freelancers across 8+ categories',
      icon: Globe,
      color: 'from-ajira-primary to-ajira-blue-600',
    },
    {
      ...
      description:
        'Compare portfolios, reviews, and prices to find the perfect match for your project',
      icon: Target,
      color: 'from-ajira-secondary to-ajira-green-600',
    },
    {
      ...
      description:
        'Work directly with your chosen freelancer using our secure platform and communication tools',
      icon: Users,
      color: 'from-ajira-accent to-ajira-orange-600',
    },
    {
      ...
      title: 'Review & Pay',
      description:
        "Review the completed work, provide feedback, and pay securely when you're 100% satisfied",
      icon: CheckCircle,
    ...
    <section className='py-20 bg-white'>
      <div className='max-w-7xl mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-ajira-text-muted max-w-3xl mx-auto'>
            From idea to completion, our platform makes it easy to connect with
            top talent and get professional results
          </p>
        </div>
            ...
            return (
              <div key={index} className='relative group'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-ajira-lg hover:shadow-ajira-xl transition-all duration-300 border border-ajira-gray-200 hover:border-ajira-primary/30 text-center group-hover:-translate-y-2'>
                  {/* Step Number */}
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} text-white font-bold text-xl mb-6 shadow-ajira-lg`}
                  >
                    {step.step}
                  </div>
            ...
            >
              ...
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <div className='text-xl font-bold text-ajira-primary'>
                    {service.orders}
                  </div>
                </div>
