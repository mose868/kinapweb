  ...
  const features = [
    {
      ...
      description:
        aboutData?.mission ||
        'To cultivate digital skills excellence and showcase successful online work opportunities among our club members.',
    },
    {
      ...
      description:
        ...
        'A vibrant student club dedicated to developing digital skills and exploring online work opportunities under the Ajira Digital program.',
    },
    {
      ...
      description:
        aboutData?.vision ||
        'A digitally empowered generation of skilled professionals.',
    },
    {
      ...
      description:
        aboutData?.history ||
        'Our members have completed numerous successful projects and secured various online work opportunities through skills gained in the club.',
    },
  ];
          ...
          <div className='text-center mb-8 sm:mb-12'>
            ...
            <p className='text-base sm:text-lg text-gray-600 max-w-2xl mx-auto'>
              {aboutData?.values
                ...
                : 'Our commitment to excellence in digital skills development and community building'}
            </p>
          </div>
          ...
          <div className='max-w-4xl mx-auto w-full'>
            <div className='text-center mb-8 sm:mb-12'>
              ...
              <p className='section-subtitle text-base sm:text-lg'>
                To be the leading digital skills training hub in Kenya, creating
                a pathway to sustainable online work opportunities.
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 text-center w-full'>
              <motion.div
                ...
                className='card w-full'
              >
                <h3 className='text-xl sm:text-3xl font-bold text-ajira-blue mb-1 sm:mb-2'>
                  1000+
                </h3>
                <p className='text-ajira-gray text-xs sm:text-base'>
                  Students Trained
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className='card w-full'
              >
                <h3 className='text-xl sm:text-3xl font-bold text-ajira-orange mb-1 sm:mb-2'>
                  25+
                </h3>
                <p className='text-ajira-gray text-xs sm:text-base'>
                  Training Programs
              ...
              <motion.div
                ...
                className='card w-full'
              >
                <h3 className='text-xl sm:text-3xl font-bold text-ajira-gold mb-1 sm:mb-2'>
                  95%
                </h3>
                <p className='text-ajira-gray text-xs sm:text-base'>
                  Success Rate
          ...
          <div className='bg-gradient-ajira rounded-2xl p-4 sm:p-8 md:p-12 w-full'>
            <div className='max-w-3xl mx-auto text-center w-full'>
              ...
              <p className='text-base sm:text-lg text-white/90 mb-6 sm:mb-8'>
                Join our community of digital professionals and unlock endless
