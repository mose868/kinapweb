...
const FaqPage = () => {
    ...
    const fetchFAQs = async () => {
      try {
        ...
        const uniqueCategories = Array.from(
          new Set(faqData.map((faq: FaqItem) => faq.category))
        );
  ...
  return (
    <div className='container-custom py-8 sm:py-12 w-full px-2 sm:px-4 overflow-x-hidden'>
      <h1 className='text-4xl font-bold text-ajira-primary mb-8'>
          ...
          .map((category) => {
            ...
            return (
              <div key={category} className='space-y-4 w-full'>
                <h2 className='text-2xl font-semibold text-ajira-primary'>
                  {category}
                </h2>
                          ...
                          <div className='p-4 bg-gray-50 border-t border-gray-200'>
                            ...
                            <div className='flex flex-col sm:flex-row items-center justify-between mt-4 pt-4 border-t border-gray-200 gap-2 w-full'>
                              ...
                              <div className='flex items-center gap-2 flex-wrap'>
                                ...
                                <button
                                  onClick={() =>
                                    handleVote(faq._id, 'not-helpful')
                                  }
                                  disabled={!!hasVoted}
                                  className={`p-2 rounded-lg transition ${
