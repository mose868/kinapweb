...
const Contact = () => {
  ...
  const openWhatsApp = () => {
    if (whatsappLink) {
      ...
      const message =
        'Hi, I would like to get in touch with Ajira Digital KiNaP Club.';
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Email Us',
      details: ['kinapajira@gmail.com', 'info@kinapajira.com'],
    },
    {
      icon: <Phone className='w-6 h-6 text-ajira-gold' />,
      title: 'Call Us',
      details: ['+254 792 343 958', 'WhatsApp Available'],
    },
    {
          ...
          <div className='max-w-3xl mx-auto text-center w-full'>
            ...
            >
              ...
              <p className='text-base sm:text-lg md:text-xl text-white/90'>
                ...
                succeed in your digital journey.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                {info.details.map((detail, i) => (
                  <p
                    key={i}
                    className='text-ajira-gray text-sm sm:text-base mb-1'
                  >
                    {detail}
                  </p>
                ))}
            ...
            <div className='card w-full'>
              <div className='text-center mb-8'>
                ...
                <p className='text-ajira-gray text-sm sm:text-base'>
                  ...
                  hours. Your message will be sent directly to our team.
                </p>
              </div>
              ...
              {success && (
                <div className='bg-green-50 text-green-600 p-4 rounded-lg mb-6'>
                  ...
                  <p className='text-sm mb-4'>
                    ...
                    kinapajira@gmail.com and we'll get back to you soon.
                  </p>
                  {whatsappLink && (
              ...
              <form onSubmit={handleSubmit} className='space-y-6'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full'>
                  <div>
                    <label
                      htmlFor='name'
                      className='block text-sm font-medium text-ajira-gray mb-2'
                    >
                      Your Name *
                    </label>
                    <input
