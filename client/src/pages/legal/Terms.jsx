        ...
        <div className='max-w-4xl mx-auto'>
          ...
          >
            <div className='text-center mb-8'>
              ...
              <p className='text-ajira-gray'>Last updated: March 2024</p>
            </div>
            ...
            <div className='space-y-8 text-ajira-gray'>
              <section>
                ...
                <p className='mb-4'>
                  By accessing and using the Ajira Digital - Kiambu National
                  Polytechnic Hub website and services, you agree to be bound by
              ...
              <section>
                ...
                <p className='mb-4'>
                  Ajira Digital - Kiambu National Polytechnic Hub provides
                  digital skills training, online work opportunities, and
                  related services to empower youth in Kenya's digital economy.
                </p>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  owned by Ajira Digital, its licensors, or other providers and
              ...
              <section>
                ...
                <p className='mb-4'>
                  Ajira Digital - Kiambu National Polytechnic Hub shall not be
                  liable for any indirect, incidental, special, consequential,
                  or punitive damages resulting from your use or inability to
                  use the services.
                </p>
              </section>
              ...
              <section>
                ...
                <p className='mt-2'>
                  Email: legal@kiambuajira.ac.ke
                  <br />
                  Phone: +254 700 000 000
                  <br />
                  Address: Kiambu National Polytechnic, P.O. Box 414-00900,
                  Kiambu, Kenya
                </p>
              </section>
            </div>
