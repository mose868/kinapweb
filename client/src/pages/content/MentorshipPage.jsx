...
const MentorshipPage = () => {
  ...
  useEffect(() => {
    filterMentors();
  }, [selectedCategory, selectedExpertise, selectedCity, showFreeOnly, showInstantOnly, searchQuery, mentors]);
  ...
  const filterMentors = () => {
    ...
    if (selectedCity !== 'all') {
      filtered = filtered.filter(mentor => mentor.location.city === selectedCity);
    }
    ...
    if (showInstantOnly) {
      filtered = filtered.filter(mentor => mentor.instantAvailability.enabled);
    }
  ...
  const submitMentorRequest = async (e) => {
    ...
    try {
      ...
      setRequestStatus({
        type: 'success',
        message: 'Request sent to available mentors! Expected response time: 15 minutes',
        data: {
    ...
    <div className="min-h-screen bg-gray-50 py-8 sm:py-12 w-full overflow-x-hidden">
      <div className="container-custom px-2 sm:px-4 w-full">
        ...
        <div className="bg-gradient-to-r from-ajira-primary to-ajira-secondary rounded-lg p-4 sm:p-8 text-center text-white mb-12 w-full">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">Find Your Perfect Mentor</h1>
          <p className="text-base sm:text-xl mb-8 opacity-90">
            ...
            Get personalized advice, industry insights, and accelerate your growth.
          </p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-8 w-full">
            ...
            <div className="flex items-center space-x-4">
              ...
              <label className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-ajira-primary"
                />
                <span className="text-sm font-medium text-gray-700">Instant Available</span>
              </label>
          ...
          <div className="flex items-center justify-between text-sm text-gray-600">
            <span>{filteredMentors.length} mentor{filteredMentors.length !== 1 ? 's' : ''} found</span>
        ...
        <div className="mt-16 bg-gradient-to-r from-ajira-primary to-ajira-secondary rounded-lg p-4 sm:p-8 text-center text-white w-full">
          <h2 className="text-xl sm:text-3xl font-bold mb-4">Ready to accelerate your career?</h2>
          <p className="text-base sm:text-xl mb-8 opacity-90">
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-900">Request Instant Mentoring</h2>
                <button
              ...
              <p className="text-gray-600 mt-2">
                Get matched with available mentors in minutes. Just like requesting an Uber!
              </p>
            </div>
            ...
            <form onSubmit={submitMentorRequest} className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleRequestDataChange('name', e.target.value, 'mentee')}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleRequestDataChange('email', e.target.value, 'mentee')}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleRequestDataChange('category', e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
                    required
                  >
                    {categories.map(category => (
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleRequestDataChange('sessionType', e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
                    required
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleRequestDataChange('urgency', e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleRequestDataChange('preferredDuration', parseInt(e.target.value))}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
                    min="15"
                    max="120"
                    step="15"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => handleRequestDataChange('problemDescription', e.target.value)}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
                  rows="4"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleRequestDataChange('city', e.target.value, 'location')}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
                  >
                ...
                <div className="flex items-center space-x-4 pt-8">
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => handleRequestDataChange('preferInPerson', e.target.checked, 'location')}
                      className="w-4 h-4 text-ajira-primary"
                    />
                    <span className="text-sm text-gray-700">Prefer in-person meeting</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                <label className="flex items-center space-x-2 mb-3">
                  <input
                    ...
                    onChange={(e) => handleRequestDataChange('hasBudget', e.target.checked, 'budget')}
                    className="w-4 h-4 text-ajira-primary"
                  />
                  <span className="text-sm font-medium text-gray-700">I have a budget for this session</span>
                </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleRequestDataChange('maxAmount', parseInt(e.target.value), 'budget')}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
                        placeholder="5000"
                        min="0"
                      />
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => handleRequestDataChange('currency', e.target.value, 'budget')}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ajira-primary/50"
                      >
        ...
        <div className="p-6">
          <div className="flex items-start space-x-4">
            <div className="w-16 h-16 bg-gradient-to-r from-ajira-primary to-ajira-secondary rounded-full flex items-center justify-center text-white text-lg font-bold">
              {mentor.mentor.name.split(' ').map(n => n[0]).join('')}
            </div>
            
            <div className="flex-1">
              <div className="flex items-start justify-between mb-2">
                <div>
                  <h3 className="text-lg font-bold text-gray-900">{mentor.title}</h3>
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-500">({mentor.ratings.totalRatings} reviews)</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  <p className="text-lg font-bold text-ajira-primary">
                    {mentor.pricing.isFree ? 'Free' : `${mentor.pricing.currency} ${mentor.pricing.sessionRate}`}
                  </p>
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
      <div className="p-6">
        ...
        <p className="text-sm text-gray-600 mb-4 line-clamp-2">{mentor.mentor.bio}</p>
