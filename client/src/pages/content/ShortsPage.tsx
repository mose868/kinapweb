  ...
  <div className="min-h-screen bg-white px-4 py-8">
    ...
    {shorts.length === 0 ? (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
        {shorts.map(video => (
          <div key={video.id} className="bg-white rounded-xl shadow hover:shadow-lg transition-shadow cursor-pointer overflow-hidden group">
            ...
            <div className="p-2">
              ...
              <div className="flex items-center gap-2 mb-1">
                <img src={video.channel.avatar || DEFAULT_AVATAR} alt={video.channel.name} className="w-5 h-5 rounded-full" />
