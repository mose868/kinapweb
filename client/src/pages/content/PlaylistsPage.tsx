  ...
  return (
    <div className="min-h-screen bg-white px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="text-gray-500 text-lg">No playlists yet. Create one above!</div>
      ) : (
        <div className="space-y-8">
          {playlists.map(playlist => (
            <div key={playlist.name}>
              <h2 className="text-xl font-bold text-gray-800 mb-3">{playlist.name}</h2>
              {playlist.videos.length === 0 ? (
                <div className="text-gray-400 mb-6">No videos in this playlist.</div>
              ) : (
