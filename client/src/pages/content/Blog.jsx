  ...
  const posts = [
    {
      ...
      excerpt:
        "Learn how John transformed his programming hobby into a successful freelancing career through Ajira Digital's training program.",
      image:
    ...
    },
    {
      ...
      excerpt:
        'Discover the most sought-after digital skills that employers and clients are looking for in the current job market.',
      image:
    ...
    },
    {
      ...
      excerpt:
        'Essential tips and strategies for creating a strong personal brand that attracts clients and opportunities.',
      image:
    ...
    },
    {
      ...
      excerpt:
        'A comprehensive guide to finding and securing online work opportunities through various platforms.',
      image:
    ...
    },
    {
      ...
      excerpt:
        'How artificial intelligence is creating new opportunities for digital workers and freelancers.',
      image:
    ...
    },
    {
      ...
      excerpt:
        'Master the art of remote work with these proven strategies and tools for maximum productivity.',
      image:
    ...
    const demoPosts = [
      {
        ...
        excerpt:
          'A quick look at how Ajira Digital helped me become a successful freelancer in the new year.',
        image:
      ...
      },
      {
        ...
        excerpt:
          'Explore the latest digital trends and opportunities for the year ahead.',
        image:
      ...
      },
      {
        ...
        excerpt:
          'Essential tips for creating a standout portfolio that gets you hired.',
        image:
          'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop',
        author: 'Career Coach',
        date: 'January 3, 2025',
          ...
          <div className='container-custom'>
            ...
            <div className='mt-8 text-center'>
              <p className='text-gray-500'>
                Sign up or log in to read and write your own stories!
              </p>
            </div>
          </div>
        </section>
          ...
          <div className='max-w-3xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-lg md:text-xl text-white/90 mb-8'>
                Discover success stories, career tips, and industry insights
                from our community
              </p>
              ...
              <div className='relative max-w-xl mx-auto'>
                <Search
                  className='absolute left-4 top-1/2 transform -translate-y-1/2 text-ajira-gray'
                  size={20}
                />
                <input
                  type='text'
