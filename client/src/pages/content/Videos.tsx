...
const mockVideos = [
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=react',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=ai',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=project',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=javascript',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=datascience',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=reactnative',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=marketing',
    videoUrl: 'https://www.youtube.com/embed/bMknfKXIFA8',
    duration: '55:20',
    views: '198K',
    uploadDate: '1 week ago',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=freelance',
    videoUrl: 'https://www.youtube.com/embed/WZQc7RUAg18',
    duration: '33:45',
    views: '156K',
    uploadDate: '2 weeks ago',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=content',
    videoUrl: 'https://www.youtube.com/embed/VozPNrt-LfE',
    duration: '42:15',
    views: '134K',
    uploadDate: '3 days ago',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=dataentry',
    videoUrl: 'https://www.youtube.com/embed/ua-CiDNNj30',
    duration: '28:30',
    views: '98K',
    uploadDate: '5 days ago',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=success',
    videoUrl: 'https://www.youtube.com/embed/aircAruvnKk',
    duration: '18:45',
    views: '245K',
    uploadDate: '1 week ago',
  ...
  },
  {
    ...
    thumbnail: 'https://picsum.photos/320/180?random=livecoding',
...
const Videos: React.FC = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        ...
        !videoOptionsRef.current.contains(event.target as Node)
      ) {
  ...
  const getVerificationBadge = (channel: any) => {
    ...
    switch (channel.verificationBadge) {
      case 'official':
        return (
          <div
            className='w-4 h-4 bg-gray-600 rounded-full flex items-center justify-center ml-1 flex-shrink-0'
      ...
      case 'verified':
        return (
          <div
            className='w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center ml-1 flex-shrink-0'
      ...
      case 'music':
        return (
          <div
            className='w-4 h-4 bg-red-500 rounded-full flex items-center justify-center ml-1 flex-shrink-0'
            title='Official Music Channel'
          >
  ...
  const getTrendingVideos = () => {
    return [...videos]
      ...
      .sort((a, b) => {
        ...
        const getViews = (v) =>
          parseInt((v.views || '').replace(/[^\d]/g, '')) || 0;
  ...
  const tradingVideos = videos.filter(
    (v) =>
      v.category?.toLowerCase() === 'trading' ||
      v.tags?.some((tag) => tag.toLowerCase() === 'trading')
  );
      ...
      <aside className='hidden md:flex flex-col w-60 bg-white border-r border-gray-200 py-6 px-2 fixed left-0 top-0 bottom-0 z-40'>
        ...
        <nav className='flex flex-col gap-2'>
          <NavLink
            to='/videos'
            className={({ isActive }) =>
              `flex items-center gap-4 px-4 py-2 rounded-lg hover:bg-gray-100 font-medium ${isActive ? 'bg-gray-200 text-gray-900' : 'text-gray-900'}`
            }
          >
            <Home size={22} /> Home
          </NavLink>
          <NavLink
            to='/shorts'
            className={({ isActive }) =>
              `flex items-center gap-4 px-4 py-2 rounded-lg hover:bg-gray-100 ${isActive ? 'bg-gray-200 text-gray-900' : 'text-gray-700'}`
            }
          >
        ...
        <div className='mt-8'>
          <h4 className='text-xs text-gray-500 font-semibold mb-2 px-4'>
            Subscriptions
          </h4>
          <nav className='flex flex-col gap-2'>
      ...
      <div className='flex-1 flex flex-col ml-0 md:ml-60 w-full'>
        ...
        <header className='sticky top-0 z-30 bg-white border-b border-gray-200 flex flex-col sm:flex-row items-center justify-between px-2 sm:px-4 py-3 w-full'>
          <div className='flex items-center gap-4'>
            ...
            <span className='text-xl font-bold text-red-600 md:hidden'>
              Kinap Hub
            </span>
          </div>
          <div className='flex-1 flex justify-center'>
            ...
            <div
              className='relative flex-1 max-w-2xl mx-4 mb-4 flex items-center'
              style={{ gap: '1.5rem' }}
            >
              ...
              {filteredVideos.map((video) => (
                <motion.div
                  ...
                  className={`group cursor-pointer ${
                    viewMode === 'list'
                      ? 'flex bg-[#181818] rounded-lg overflow-hidden hover:bg-[#272727]'
                      : ''
                  }`}
                  onClick={() => {
                ...
                >
                  {/* Video Thumbnail */}
                  <div
                    className={`relative ${viewMode === 'list' ? 'w-80 flex-shrink-0' : 'aspect-video'} rounded-lg overflow-hidden`}
                  >
                    <img
                      src={video.thumbnail}
                      alt={video.title}
            ...
            <div className='text-center py-12'>
              ...
              <div className='mt-8'>
                <h4 className='text-lg font-bold text-white mb-4'>
                  Trending Now (Verified Creators)
                </h4>
          ...
          <div className='relative w-full max-w-[1400px] mx-auto flex flex-col md:flex-row items-start justify-center min-h-[80vh] py-4 sm:py-8 px-1 sm:px-2 md:px-0 gap-4 sm:gap-8'>
            ...
            <div className='flex-1 flex flex-col items-center md:items-start justify-start w-full max-w-3xl mx-auto'>
              ...
              <div className='w-full flex justify-center items-center mb-4 sm:mb-6 mt-4 sm:mt-8 md:mt-0'>
                <div
                  className='relative w-full aspect-video bg-black rounded-2xl shadow-2xl overflow-hidden flex items-center justify-center'
                  style={{ minHeight: '180px', maxWidth: '900px' }}
                >
              ...
              <div
                className='w-full bg-white rounded-b-xl shadow-none p-0 mt-0'
                style={{ maxWidth: '900px' }}
              >
                {/* Title */}
                <h2 className='text-2xl md:text-3xl font-bold text-gray-900 mb-3 leading-tight text-left px-2 md:px-0'>
                  {selectedVideo.title}
                </h2>
                ...
                <div className='flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4 px-2 md:px-0'>
                  <div className='flex items-center'>
                    <img
                      src={selectedVideo.channel.avatar || DEFAULT_AVATAR}
                      alt={selectedVideo.channel.name}
                      className='w-12 h-12 rounded-full mr-4 border-2 border-gray-200 bg-white object-cover'
                    />
                    <div>
                      <div className='flex items-center'>
                        <span className='font-semibold text-gray-900 mr-2 text-lg'>
                          {selectedVideo.channel.name}
                        </span>
                        {getVerificationBadge(selectedVideo.channel)}
                      </div>
                      <span className='text-gray-500 text-sm'>
                        {selectedVideo.channel.subscribers} subscribers
                      </span>
                    </div>
                    <button className='ml-6 px-5 py-2 bg-red-600 text-white font-semibold rounded-full shadow hover:bg-red-700 transition-colors text-base'>
                      Subscribe
                    </button>
                  </div>
                  {/* Action Row */}
                  <div className='flex flex-wrap items-center gap-2 mt-2 md:mt-0'>
                    <button
                      className={`flex items-center space-x-2 px-4 py-2 rounded-full font-medium text-base shadow-sm border border-gray-200 ${likes[selectedVideo.id] ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700 hover:bg-blue-50'}`}
                      onClick={() => handleLike(selectedVideo.id)}
                    >
                      <ThumbsUp size={18} />
                      <span>
                        {selectedVideo.likes +
                          (likes[selectedVideo.id] ? 1 : 0)}
                      </span>
                    </button>
                    <button
                      className={`flex items-center space-x-2 px-4 py-2 rounded-full font-medium text-base shadow-sm border border-gray-200 ${dislikes[selectedVideo.id] ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-700 hover:bg-red-50'}`}
                      onClick={() => handleDislike(selectedVideo.id)}
                    >
                      <ThumbsDown size={18} />
                      <span>
                        {selectedVideo.dislikes +
                          (dislikes[selectedVideo.id] ? 1 : 0)}
                      </span>
                    </button>
                    <button
                      className='flex items-center space-x-2 px-4 py-2 rounded-full font-medium text-base shadow-sm border border-gray-200 bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors'
                      onClick={() => handleShare(selectedVideo.videoUrl)}
                    >
                      <Share2 size={18} />
                      <span>Share</span>
                    </button>
                    <button
                      ...
                      disabled={selectedVideo.videoUrl.includes('youtube.com')}
                      title={
                        selectedVideo.videoUrl.includes('youtube.com')
                          ? 'Download not available for YouTube videos'
                          : 'Download'
                      }
                    >
                      <Download size={18} />
                ...
                <div className='mt-4 px-2 md:px-0'>
                  ...
                  <div className='space-y-3 max-h-48 overflow-y-auto'>
                    ...
                    {(comments[selectedVideo.id] || []).map((c, i) => (
                      <div
                        key={i}
                        className='bg-gray-100 rounded-lg px-4 py-2 text-gray-900 text-sm'
                      >
                        {c}
                      </div>
                    ))}
                ...
                {sortedVideos
                  ...
                  .map((rec) => (
                    ...
                    >
                      ...
                      />
                      <div className='flex-1 min-w-0'>
                        <h4 className='text-gray-900 font-medium text-base line-clamp-2 mb-1'>
                          {rec.title}
                        </h4>
                        ...
                        <span className='text-gray-400 text-xs'>
                          {rec.duration} • {formatViews(rec.views)}
                        </span>
                      </div>
                    </div>
                  ))}
                ...
                >
                  {videoPreviewUrl && (
                    <video
                      src={videoPreviewUrl}
                      controls
                      className='w-full rounded-lg mb-2 max-h-56 bg-black'
                    />
                  )}
                  <input
                    type='text'
                  ...
                  <div className='flex justify-between mt-2'>
                    <button
                      ...
                      onClick={() => {
                        setUploadStep(1);
                        setVideoPreviewUrl('');
                        setUploadForm((f) => ({ ...f, videoFile: null }));
                      }}
                    >
                      Back
                    </button>
