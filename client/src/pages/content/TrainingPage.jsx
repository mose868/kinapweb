      ...
      <div className='container-custom px-2 sm:px-4 w-full'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-base sm:text-lg text-gray-600 max-w-3xl mx-auto'>
            Transform your career with cutting-edge digital skills training
        ...
        <div className='text-center py-16'>
          <div className='bg-white rounded-2xl shadow-lg p-8 sm:p-12 max-w-5xl mx-auto'>
            ...
            <p className='text-gray-600 text-lg mb-8'>
              We're building a comprehensive digital skills academy that will
              revolutionize how you learn, grow, and succeed in the digital
              economy. Get ready for:
            </p>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 text-left'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Engage with video tutorials, hands-on projects, and
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Learn from industry professionals and successful digital
                    entrepreneurs
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Skills that directly translate to job opportunities and
                    career advancement
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Earn recognized certificates to boost your professional
                    credibility
                  </p>
                </div>
              </div>
            ...
            <div className='bg-gradient-to-r from-ajira-primary/10 via-ajira-accent/10 to-ajira-secondary/10 rounded-xl p-6 mb-6'>
              <h3 className='font-semibold text-ajira-primary mb-4'>
                Upcoming Course Categories:
              </h3>
            ...
            <div className='bg-ajira-primary/5 rounded-lg p-6 mb-6'>
              <h3 className='font-semibold text-ajira-primary mb-2'>
                Why Choose Our Training Academy?
              </h3>
              <p className='text-gray-700 text-sm mb-4'>
                Our training programs are specifically designed for the African
                digital economy, combining global best practices with local
                market insights. We focus on practical, job-ready skills that
            ...
            <p className='text-gray-500 text-sm'>
              We're finalizing our curriculum and assembling our expert
              instructor team. Get ready to accelerate your digital career! 🚀
            </p>
          </div>
        </div>
        ...
        <div className='bg-gradient-to-r from-ajira-primary to-ajira-secondary rounded-2xl p-6 sm:p-8 text-center w-full'>
          ...
          <p className='text-white/90 mb-6 max-w-2xl mx-auto text-sm sm:text-base'>
            Join thousands of learners who will master in-demand digital skills
            and advance their careers. Be among the first to access our
