        ...
        <div className='text-center py-16'>
          <div className='bg-white rounded-2xl shadow-lg p-8 sm:p-12 max-w-3xl mx-auto'>
            ...
            <p className='text-gray-600 text-lg mb-8'>
              We're curating amazing success stories from our community members
              who have transformed their careers and lives through digital
              skills. Get ready to be inspired by real journeys of:
            </p>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8 text-left'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    From traditional jobs to thriving digital careers
                  </p>
                </div>
              </div>
              <div className='flex items-start gap-4'>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Scaling small businesses with digital tools
                  </p>
                </div>
              </div>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Mastering in-demand digital skills
                  </p>
                </div>
              </div>
            </div>
            <div className='bg-gradient-to-r from-ajira-primary/10 to-ajira-accent/10 rounded-lg p-6 mb-6'>
              ...
              <p className='text-gray-700 text-sm'>
                When we launch, you'll be able to share your own success story
                and inspire others in the community. Your journey could be the
                motivation someone else needs to start their digital
                transformation.
              </p>
            </div>
            <p className='text-gray-500 text-sm'>
              We're working hard to bring you authentic, inspiring stories. Stay
    ...
    <div className='max-w-7xl mx-auto px-2 sm:px-4 py-8 sm:py-12 w-full overflow-x-hidden'>
      <div className='text-center mb-12'>
        ...
        <p className='text-base sm:text-lg text-gray-600 max-w-2xl mx-auto'>
          Discover how Ajira Digital has transformed careers and lives. Read
          inspiring stories from our community members and share your own
          journey.
        </p>
      </div>
