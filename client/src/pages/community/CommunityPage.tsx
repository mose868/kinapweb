...
const CommunityPage = () => {
  ...
  const demoGroups: ChatGroup[] = [
    ...
    },
    {
      id: 'sheng-vibes',
      name: 'Sheng Vibes 🔥',
      description: 'Casual mazungumzo, memes na general vibes za wasee',
      avatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=100&h=100&fit=crop&crop=face',
      members: 567,
      lastMessage: 'Mike: Hii jua ya Nairobi inaniua, anyone else feeling the heat?',
      ...
      messages: [
        {
          id: '1',
          userId: 'user13',
          userName: 'Mike Otieno',
          userAvatar: 'https://randomuser.me/api/portraits/men/89.jpg',
          message: 'Wasee, hii jua ya Nairobi inaniua leo! Anyone else feeling the heat?',
          timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
        },
        {
          id: '2',
          ...
          message: 'Eish Mike! Niko kwa office na AC lakini bado najiskia kama niko kwa jiko 😂',
          timestamp: new Date(Date.now() - 1.5 * 60 * 60 * 1000),
        },
        {
          id: '3',
          userId: 'user15',
          userName: 'Brian Kiprotich',
          userAvatar: 'https://randomuser.me/api/portraits/men/56.jpg',
          message: 'Hapa Eldoret ni poa, lakini naona weather forecast inasema mvua kesho. Finally!',
          timestamp: new Date(Date.now() - 1 * 60 * 60 * 1000),
        },
        {
          id: '4',
          ...
          userName: 'Mike Otieno',
          userAvatar: 'https://randomuser.me/api/portraits/men/89.jpg',
          message: 'Hii jua ya Nairobi inaniua, anyone else feeling the heat? Nataka kuenda coast 🏖️',
        ...
        {currentGroup ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-500">Chagua group ili uanze mazungumzo na community</p>
            </div>
          </div>
        )}
      </div>
