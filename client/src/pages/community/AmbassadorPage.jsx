  ...
  const ambassadorBenefits = [
    {
      ...
      description:
        'Get official ambassador status and recognition within the Ajira Digital community.',
    },
    {
      icon: <Gift className='w-8 h-8 text-ajira-accent' />,
      title: 'Rewards & Incentives',
      description:
        'Earn points, certificates, and exclusive merchandise for your contributions.',
    },
    {
      icon: <Users className='w-8 h-8 text-ajira-accent' />,
      title: 'Leadership Opportunities',
      description:
        'Lead workshops, mentor new members, and represent the club at events.',
    },
    {
      icon: <TrendingUp className='w-8 h-8 text-ajira-accent' />,
      title: 'Skill Development',
      description:
        'Access advanced training programs and professional development resources.',
    },
  ];
  ...
  const tasks = [
    {
      ...
      description:
        'Lead a study group for new members on digital marketing basics',
      points: 150,
      deadline: '2025-01-15',
      difficulty: 'Medium',
    },
    {
      ...
      description:
        'Design and post 3 engaging posts about Ajira Digital opportunities',
      points: 100,
      deadline: '2025-01-10',
      difficulty: 'Easy',
    },
    {
      ...
      description:
        'Guide 5 new members through their first week in the program',
      points: 200,
      deadline: '2025-01-20',
      difficulty: 'Hard',
    },
          ...
          <div className='max-w-4xl mx-auto text-center w-full'>
            ...
            >
              ...
              <p className='text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto'>
                Join our elite community of student leaders and help shape the
                future of digital skills at Kiambu National Polytechnic.
              </p>
            ...
            >
              <div className='text-center mb-12'>
                ...
                <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
                  Our Ambassador Program recognizes and empowers outstanding
                  students who demonstrate leadership, commitment, and passion
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-12'>
                ...
                <div className='bg-white rounded-lg shadow-lg p-8'>
                  ...
                  <h3 className='text-xl font-bold text-ajira-primary mb-3'>
                    Our Mission
                  </h3>
                  <p className='text-gray-600'>
                    To create a network of student leaders who inspire, mentor,
                    and guide their peers towards success in the digital
                    economy.
                  </p>
                </div>
                <div className='bg-white rounded-lg shadow-lg p-8'>
                  ...
                  <p className='text-gray-600'>
                    Ambassadors have helped over 500+ students discover digital
                    opportunities and develop essential skills for the modern
                    workforce.
                  </p>
                </div>
              </div>
              ...
              <div className='bg-ajira-primary rounded-lg p-8 text-center'>
                ...
                <p className='text-white/90 mb-6'>
                  Join our ambassador program and become a catalyst for change
                  in your community.
                </p>
            ...
            >
              <div className='text-center mb-12'>
                ...
                <p className='text-lg text-gray-600'>
                  Exclusive perks and opportunities for our dedicated
                  ambassadors
                </p>
              </div>
          ...
          {activeTab === 'tasks' && (
            ...
            >
              <div className='text-center mb-12'>
                ...
                <p className='text-lg text-gray-600'>
                  Complete tasks to earn points and make an impact in your
                  community
                </p>
              </div>
