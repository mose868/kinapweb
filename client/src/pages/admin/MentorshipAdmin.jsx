...
const MentorshipAdmin = () => {
  ...
  const { data: mentorshipStats } = useQuery(
    'mentorshipStats',
    async () => {
      const response = await axios.get(`${BASEURL}/mentorship/admin/stats/overview`);
      return response.data;
    }
  );
  ...
  const saveMentorMutation = useMutation(
    async (data) => {
      if (editingMentor) {
        const response = await axios.put(`${BASEURL}/mentorship/admin/${editingMentor._id}`, {
          ...data,
    ...
    },
    {
      onSuccess: () => {
        ...
        setMessage(editingMentor ? 'Mentor updated successfully!' : 'Mentor created successfully!');
  ...
  const toggleStatusMutation = useMutation(
    async ({ id, status }) => {
      const response = await axios.patch(`${BASEURL}/mentorship/admin/${id}/status`, { status });
      return response.data;
    },
    {
      onSuccess: () => {
  ...
  const toggleFeaturedMutation = useMutation(
    async (id) => {
      const response = await axios.patch(`${BASEURL}/mentorship/admin/${id}/feature`);
      return response.data;
    },
    {
      onSuccess: () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'Pending Approval': return 'text-blue-600 bg-blue-100';
  ...
  const getExpertiseColor = (level) => {
    switch (level) {
      ...
      case 'Mid-Level': return 'text-blue-600 bg-blue-100';
      case 'Senior': return 'text-purple-600 bg-purple-100';
      case 'Expert': return 'text-yellow-600 bg-yellow-100';
      case 'Thought Leader': return 'text-red-600 bg-red-100';
      default: return 'text-gray-600 bg-gray-100';
    }
  };
  ...
  const getBadgeColor = (badge) => {
    switch (badge) {
      ...
      case 'Gold': return 'text-yellow-600 bg-yellow-200';
  ...
  const filteredMentors = mentorsData?.mentors?.filter(mentor => {
    ...
    return mentor.mentor.name.toLowerCase().includes(query) ||
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg p-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-ajira-primary">Mentorship Management</h1>
          <button
            ...
            <div className="bg-ajira-primary/10 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-ajira-primary">{mentorshipStats.mentorStats?.totalMentors || 0}</p>
                </div>
              </div>
            </div>
            <div className="bg-green-100 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{mentorshipStats.mentorStats?.activeMentors || 0}</p>
                </div>
              </div>
            </div>
            <div className="bg-purple-100 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">{mentorshipStats.mentorStats?.availableMentors || 0}</p>
                </div>
              </div>
            </div>
            <div className="bg-blue-100 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{mentorshipStats.requestStats?.activeRequests || 0}</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="flex items-center space-x-2 pt-8">
                      ...
                      />
                      <label className="text-sm font-medium text-gray-700">Free Mentorship</label>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleArrayChange(e.target.value, 'specializations')}
                        rows={3}
                  ...
                  <div className="flex items-center space-x-6">
                    <label className="flex items-center space-x-2">
                      <input
                        ...
                        className="w-5 h-5 text-ajira-primary"
                      />
                      <span className="text-sm font-medium text-gray-700">Featured Mentor</span>
                    </label>
                    ...
                    <label className="flex items-center space-x-2">
                      <input
                        ...
                        className="w-5 h-5 text-ajira-primary"
                      />
                      <span className="text-sm font-medium text-gray-700">Instant Requests</span>
                    </label>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="text-lg font-semibold text-gray-900">{mentor.mentor.name}</h3>
                        {mentor.isFeatured && (
                      ...
                      <p className="text-gray-600 mb-3 line-clamp-2">{mentor.description}</p>
                      
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-3">
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(mentor.status)}`}>
                          {mentor.status}
                        </span>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${getExpertiseColor(mentor.expertiseLevel)}`}>
                          {mentor.expertiseLevel}
                        </span>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${getBadgeColor(mentor.verification.badgeLevel)}`}>
                        ...
                        <span className="flex items-center space-x-1">
                          ...
                          <span>{mentor.availability.currentMentees}/{mentor.availability.maxMentees}</span>
                        </span>
                        <span className="flex items-center space-x-1">
                          <DollarSign className="w-4 h-4" />
                          <span>{mentor.pricing.isFree ? 'Free' : `KES ${mentor.pricing.sessionRate}/session`}</span>
                        </span>
                      </div>
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-500">
                        ...
                        {mentor.ratings.totalRatings > 0 && (
                          <span className="flex items-center space-x-1">
                            ...
                            <span>{mentor.ratings.overall} ({mentor.ratings.totalRatings})</span>
                          </span>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      ...
                      <select
                        value={mentor.status}
                        onChange={(e) => toggleStatusMutation.mutate({ id: mentor._id, status: e.target.value })}
                      ...
                      <button
                        onClick={() => toggleFeaturedMutation.mutate(mentor._id)}
        ...
        {activeTab === 'requests' && requestsData && (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Recent Mentorship Requests</h2>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span className="text-gray-500 text-sm">#{request.requestId}</span>
                    </div>
                    
                    <p className="text-gray-600 mb-3">{request.problemDescription}</p>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                      ...
                      <span>Budget: {request.budget.hasBudget ? `KES ${request.budget.maxAmount}` : 'Not specified'}</span>
                    </div>
                  </div>
                  ...
                  <div className="ml-4">
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      ...
                      request.status === 'Broadcasted' ? 'bg-yellow-100 text-yellow-800' :
            ...
            {requestsData.requests.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">No mentorship requests at the moment.</p>
              </div>
            )}
          </div>
        )}
        ...
        {activeTab === 'analytics' && mentorshipStats && (
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Mentorship Analytics</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Mentor Stats */}
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Mentor Distribution</h3>
                
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Total Mentors</span>
                    <span className="font-semibold">{mentorshipStats.mentorStats.totalMentors}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Active Mentors</span>
                    <span className="font-semibold text-green-600">{mentorshipStats.mentorStats.activeMentors}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Available Now</span>
                    <span className="font-semibold text-blue-600">{mentorshipStats.mentorStats.availableMentors}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Verified Mentors</span>
                    <span className="font-semibold text-purple-600">{mentorshipStats.mentorStats.verifiedMentors}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold">{mentorshipStats.requestStats.totalRequests}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Active Requests</span>
                    <span className="font-semibold text-orange-600">{mentorshipStats.requestStats.activeRequests}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Completed</span>
                    <span className="font-semibold text-green-600">{mentorshipStats.requestStats.completedRequests}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Avg Response Time</span>
                    <span className="font-semibold">{mentorshipStats.requestStats.averageResponseTime}min</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {mentorshipStats.mentorStats.categoryStats && (
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Mentors by Category</h3>
                
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {mentorshipStats.mentorStats.categoryStats.map((cat, index) => (
        ...
        {activeTab === 'mentors' && filteredMentors.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">
              {searchQuery ? 'No mentors match your search criteria.' : 'Start building your mentor network by adding the first mentor.'}
            </p>
            {!searchQuery && (
              <button
