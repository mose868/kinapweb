...
const ContactAdmin = () => {
  ...
  const { data: contactStats } = useQuery('contactStats', async () => {
  ...
  const handleArchive = (id) => {
    if (
      window.confirm('Are you sure you want to archive this contact message?')
    ) {
              ...
              <div className='flex items-start justify-between'>
                ...
                <div className='flex items-center space-x-2 ml-4'>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleStatusUpdate(contact, e.target.value)
                    }
