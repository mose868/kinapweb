      ...
      <div className="min-h-screen bg-ajira-lightGray py-8 sm:py-12 w-full overflow-x-hidden">
        <div className="container-custom px-2 sm:px-4 w-full">
          ...
          <div className="mb-8 flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full">
            <img src="/logo.jpeg" alt="Club Logo" className="h-10 sm:h-12 w-auto rounded-lg" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between py-3 border-b border-ajira-lightGray gap-2">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-ajira-blue text-sm sm:text-base">John Doe</p>
                        <p className="text-xs sm:text-sm text-ajira-gray">john@example.com</p>
                      </div>
                    </div>
                    <span className="text-xs sm:text-sm text-ajira-gray">2 hours ago</span>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between py-3 border-b border-ajira-lightGray gap-2">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-ajira-blue text-sm sm:text-base">Jane Smith</p>
                        <p className="text-xs sm:text-sm text-ajira-gray">jane@example.com</p>
                      </div>
                    </div>
                    <span className="text-xs sm:text-sm text-ajira-gray">5 hours ago</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-ajira p-4 sm:p-6 w-full">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <span className="font-medium text-ajira-blue">Manage About Us</span>
                  </Link>
                  ...
                  >
                    <Users size={20} className="text-ajira-blue" />
                    <span className="font-medium text-ajira-blue">Manage Team</span>
                  </Link>
                  ...
                  >
                    <FileText size={20} className="text-ajira-blue" />
                    <span className="font-medium text-ajira-blue">Club Updates</span>
                  </Link>
                  ...
                  >
                    ...
                    <span className="font-medium text-ajira-blue">FAQ Management</span>
                  </Link>
                  ...
                  >
                    ...
                    <span className="font-medium text-ajira-blue">Contact Messages</span>
                  </Link>
                  ...
                  >
                    ...
                    <span className="font-medium text-ajira-blue">Training Programs</span>
                  </Link>
                  ...
                  >
                    ...
                    <span className="font-medium text-ajira-blue">Mentorship Programs</span>
                  </Link>
                  ...
                  >
                    ...
                    <span className="font-medium text-ajira-blue">AI Mentor Recruiting</span>
                  </Link>
                  ...
                  >
                    ...
                    <span className="font-medium text-ajira-blue">Events Management</span>
                  </Link>
