...
const FAQAdmin = () => {
  ...
  const { data: faqStats } = useQuery('faqStats', async () => {
              ...
              <div className='flex items-start justify-between'>
                <div className='flex-1'>
                  ...
                  <div className='flex flex-wrap items-center gap-4 text-sm text-gray-500'>
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${getPublishStatusColor(faq.isPublished)}`}
                    >
                ...
                <div className='flex items-center space-x-2 ml-4'>
                  ...
                  >
                    <Star
                      className={`w-4 h-4 ${faq.isPopular ? 'fill-current' : ''}`}
                    />
                  </button>
          ...
          <div className='text-center py-12'>
            ...
            <p className='text-gray-600 mb-4'>
              {searchQuery
                ...
                : 'Start building your FAQ section by adding the first question.'}
            </p>
            {!searchQuery && (
              <button
