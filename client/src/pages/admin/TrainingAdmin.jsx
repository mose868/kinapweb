...
const TrainingAdmin = () => {
  ...
  const saveTrainingMutation = useMutation(
    async (data) => {
      if (editingTraining) {
        const response = await axios.put(`${BASEURL}/training/${editingTraining._id}`, {
          ...data,
    ...
    },
    {
      onSuccess: () => {
        ...
        setMessage(editingTraining ? 'Training program updated successfully!' : 'Training program created successfully!');
        setMessageType('success');
        setTimeout(() => setMessage(''), 3000);
        resetForm();
      },
      onError: (error) => {
        setMessage(error.response?.data?.message || 'Failed to save training program');
  ...
  const deleteTrainingMutation = useMutation(
    ...
    },
    {
      ...
      onError: (error) => {
        setMessage(error.response?.data?.message || 'Failed to delete training program');
        setMessageType('error');
        setTimeout(() => setMessage(''), 3000);
      }
    }
  ...
  const filteredTrainings = trainingsData?.trainings?.filter(training => {
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg p-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-ajira-primary">Training Programs</h1>
          <button
            ...
            <div className="bg-ajira-primary/10 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-ajira-primary">{trainingStats.totalTrainings}</p>
                </div>
              </div>
            </div>
            <div className="bg-green-100 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{trainingStats.publishedTrainings}</p>
                </div>
              </div>
            </div>
            <div className="bg-purple-100 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">{trainingStats.featuredTrainings}</p>
                </div>
              </div>
            </div>
            <div className="bg-blue-100 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">{trainingStats.totalEnrollments}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => handleArrayChange(e.target.value, 'learningOutcomes')}
                    rows={3}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => handleArrayChange(e.target.value, 'prerequisites')}
                    rows={3}
                ...
                >
                  {saveTrainingMutation.isLoading ? (
                    ...
                    <>
                      ...
                      <span>{editingTraining ? 'Update' : 'Create'} Training</span>
                    </>
                  )}
                </button>
              </div>
        ...
        <div className="space-y-4">
          {filteredTrainings.map((training) => (
            <div key={training._id} className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-3 line-clamp-2">{training.shortDescription || training.description}</p>
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-3">
                    ...
                    <span className="flex items-center space-x-1">
                      ...
                      <span>{training.enrollment.enrolled}/{training.enrollment.capacity}</span>
                    </span>
                    <span className="flex items-center space-x-1">
                      <DollarSign className="w-4 h-4" />
                      <span>{training.pricing.isFree ? 'Free' : `KES ${training.pricing.regularPrice.toLocaleString()}`}</span>
                    </span>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-500">
                    ...
                    {training.ratings.totalRatings > 0 && (
                      <span className="flex items-center space-x-1">
                        ...
                        <span>{training.ratings.average} ({training.ratings.totalRatings})</span>
                      </span>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-2 ml-4">
                  ...
                  >
                    {training.status === 'Published' ? <Eye className="w-4 h-4" /> : <EyeOff className="w-4 h-4" />}
                  </button>
                  ...
                  >
                    <Star className={`w-4 h-4 ${training.isFeatured ? 'fill-current' : ''}`} />
                  </button>
        ...
        {filteredTrainings.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">
              {searchQuery ? 'No programs match your search criteria.' : 'Start building your training catalog by adding the first program.'}
            </p>
            {!searchQuery && (
              <button
