...
const TeamAdmin = () => {
  ...
  // Fetch team stats
  const { data: teamStats } = useQuery('teamStats', async () => {
    ...
    async (data) => {
      if (editingMember) {
        const response = await axios.put(
          `${BASEURL}/team/${editingMember._id}`,
          {
            ...data,
            ...
            <div className='bg-ajira-accent/10 rounded-lg p-4'>
              <div className='flex items-center space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-2xl font-bold text-ajira-accent'>
                    {teamStats.founders}
                  </p>
                </div>
              </div>
            ...
            <div className='bg-ajira-secondary/10 rounded-lg p-4'>
              <div className='flex items-center space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-2xl font-bold text-ajira-secondary'>
                    {teamStats.leadership}
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className='flex items-start space-x-4'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-ajira-primary font-medium'>
                    {member.role}
                  </p>
                  {member.title && (
