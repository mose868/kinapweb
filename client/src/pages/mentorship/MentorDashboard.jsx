...
const MentorDashboard = () => {
  ...
  const [mockRequests] = useState([
    ...
    },
    {
      ...
      urgency: 'Medium',
      problemDescription:
        'Looking for guidance on transitioning to tech career',
              ...
              <div className='flex items-center space-x-4'>
                <div className='flex items-center space-x-2'>
                  ...
                  <span className='text-green-700 font-medium'>
                    You're online and available for mentoring
                  </span>
                </div>
          ...
          <div className='bg-white rounded-lg shadow-sm p-6'>
            <div className='flex items-center space-x-3'>
              ...
              <div>
                ...
                <p className='text-2xl font-bold text-gray-900'>
                  KES {mentorStats.thisWeekEarnings?.toLocaleString()}
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                <div className='flex justify-between items-center mb-6'>
                  ...
                  <div className='text-sm text-gray-600'>
                    {pendingRequests.length} active request
                    {pendingRequests.length !== 1 ? 's' : ''}
                  </div>
                </div>
                      ...
                      >
                        <div className='flex justify-between items-start mb-4'>
                          <div className='flex-1'>
                            ...
                            <div className='space-y-2 text-sm text-gray-600'>
                              ...
                              <div className='flex items-center space-x-2'>
                                ...
                                <span>
                                  {request.preferredDuration} minutes •{' '}
                                  {request.timeElapsed}
                                </span>
                              </div>
                              <div className='flex items-center space-x-2'>
                          ...
                          <div className='flex items-center space-x-2 ml-4'>
                            <button
                              onClick={() =>
                                respondToRequest(request.requestId, 'Declined')
                              }
            ...
            {activeTab === 'sessions' && (
              <div>
                <div className='flex justify-between items-center mb-6'>
                  ...
                  <div className='text-sm text-gray-600'>
                    {upcomingSessions.length} scheduled session
                ...
                {upcomingSessions.length === 0 ? (
                  <div className='text-center py-12'>
                    ...
                    <p className='text-gray-600'>
                      Accept pending requests to schedule new mentoring
                      sessions.
                    </p>
                  </div>
                ) : (
                        ...
                        <div className='flex justify-between items-start mb-4'>
                          <div className='flex-1'>
                            <div className='flex items-center space-x-3 mb-2'>
                              ...
                              <span
                                className={`px-2 py-1 rounded-full text-xs font-medium ${getSessionStatusColor(session.status.current)}`}
                              >
                            ...
                            <div className='space-y-2 text-sm text-gray-600'>
                              ...
                              <div className='flex items-center space-x-2'>
                                <Clock className='w-4 h-4' />
                                <span>
                                  {formatTime(session.scheduling.scheduledFor)}{' '}
                                  • {session.scheduling.duration} minutes
                                </span>
                              </div>
                              <div className='flex items-center space-x-2'>
                                <Video className='w-4 h-4' />
                                <span>
                                  {session.format.platform} •{' '}
                                  {session.format.type}
                                </span>
                              </div>
                            </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
                  <div className='bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white'>
                    ...
                    <p className='text-3xl font-bold'>
                      KES {mentorStats.totalEarnings?.toLocaleString()}
                    </p>
                    <p className='text-green-100 text-sm mt-2'>
                      Across {mentorStats.completedSessions} completed sessions
                    </p>
                  </div>
                  ...
                  <div className='bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white'>
                    ...
                    <p className='text-blue-100 text-sm mt-2'>
                      {mentorStats.thisWeekSessions} sessions completed
                    </p>
                  </div>
                </div>
